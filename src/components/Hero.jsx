    ...
    >
      ...
      <div className="relative z-10 space-y-8">
        ...
        <div className={`flex justify-center space-x-8 transition-all duration-700 ${visible.buttons ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <button className="group relative px-8 py-3 bg-transparent border-2 border-gray-200 text-gray-200 rounded-lg font-medium overflow-hidden transition-all duration-300 hover:border-white hover:text-black transform hover:scale-105 hover:shadow-2xl hover:shadow-white/20 active:scale-95">
          ...
          <button className="group relative px-8 py-3 bg-gray-400 text-black rounded-lg font-medium overflow-hidden transition-all duration-300 hover:bg-white transform hover:scale-105 hover:shadow-2xl hover:shadow-gray-400/30 active:scale-95">
            <span className="absolute inset-0 bg-gradient-to-r from-white to-gray-100 transform translate-x-full group-hover:translate-x-0 transition-transform duration-300 ease-out" />
        ...
        {[
          ...
          <div
            key={i}
            className={`absolute ${dot.size} bg-white rounded-full opacity-40 animate-pulse`}
